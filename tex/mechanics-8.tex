...
В данной работе экспериментально определяется коэффициент трения качения пары <<шар "--- плоская пластина>>. полных колебаний измерить угол полного отклонения $\alpha_n$, то, в соответствии с законом изменения механической энергии, можно записать %я не понимаю смысла предложения, поэтому не знаю, нужна ли тут точка
\begin{equation}
\label{eq:m8-law-of-conservation}
mgh_0^\ast - mgh_n^\ast = A_\text{тр},
\end{equation}
где %некрасиво как-то, может ты можешь что-то придумать... хотя....
\begin{equation}
\label{eq:m8-h_0^ast}
...
\end{equation}
При малых углах (не превышающих $5 \degree$) $\sin x \approx x$ и %что-то approx не уменьшилось
\begin{equation}
...
\item Отклоните шар от положения равновесия на $\alpha_0 = 4\degree$ и отпустите. %ИЗМ: отпуститЕ
...
\item Сформулировать закон сохранения энергии. %сформулируйте?
